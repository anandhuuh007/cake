      ...
      <div className="container z-10 mx-auto">
        ...
        >
          <div className="flex justify-center">
            <div className="border border-zinc-200 py-1 px-4 rounded-lg text-sm text-zinc-600 bg-white">
              Testimonials
            </div>
          </div>

          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tighter mt-5 text-center text-zinc-900">
            What our users say
          </h2>
