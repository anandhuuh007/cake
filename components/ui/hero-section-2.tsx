        ...
        <div className="flex w-full flex-col justify-center p-8 md:w-1/2 md:p-12 lg:w-3/5 lg:p-16">
            <div>
                <motion.main variants={containerVariants}>
                    ...
                    <motion.a href={callToAction.href} className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-11 px-8" variants={itemVariants}>
                        {callToAction.text}
                    </motion.a>
                </motion.main>
            </div>
